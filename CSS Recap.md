...
Flexbox (Flexible Box Layout) হল CSS-এর একটি লেআউট মডেল, যা কন্টেইনারের মধ্যে থাকা উপাদানগুলোকে সহজেই সারি বা কলাম আকারে সাজাতে ব্যবহৃত হয়। এটি উপাদানগুলোর মধ্যে স্পেস ম্যানেজ করা এবং রেসপন্সিভ ডিজাইন তৈরিতে খুব কার্যকর।  

**ব্যবহারের কারণ:**  
- উপাদানগুলো সমানভাবে বা নির্দিষ্ট অনুপাতে সাজানো।  
- দিক পরিবর্তন (row/column)।  
- উপাদানগুলোর মধ্যে স্পেস ডিস্ট্রিবিউশন এবং অ্যালাইনমেন্ট সহজ করা।  

---

### **52. Flex-grow, Flex-shrink, এবং Flex-basis-এর মধ্যে পার্থক্য কী?**  
- **Flex-grow:** একটি ফ্লেক্স আইটেম কতটা জায়গা দখল করবে, যদি অতিরিক্ত জায়গা থাকে।  
  - উদাহরণ: `flex-grow: 2` মানে আইটেমটি অন্যদের তুলনায় দ্বিগুণ জায়গা পাবে।  

- **Flex-shrink:** একটি ফ্লেক্স আইটেম কতটা সংকুচিত হবে, যদি জায়গা কম থাকে।  
  - উদাহরণ: `flex-shrink: 1` মানে জায়গা কম হলে আইটেম সংকুচিত হবে।  

- **Flex-basis:** ফ্লেক্স আইটেমের প্রাথমিক আকার সেট করে।  
  - উদাহরণ: `flex-basis: 200px` মানে আইটেমের প্রাথমিক প্রস্থ বা উচ্চতা হবে ২০০ পিক্সেল।  

---

### **53. Grid Layout কী এবং এটি কীভাবে কাজ করে?**  
CSS Grid Layout হল একটি দুই-মাত্রিক লেআউট সিস্টেম, যা সারি (rows) এবং কলাম (columns) তৈরি করে উপাদানগুলো সাজানোর জন্য ব্যবহৃত হয়।  

**কাজ করার পদ্ধতি:**  
- কন্টেইনারে `display: grid` প্রোপার্টি যোগ করে গ্রিড লেআউট সক্রিয় করা হয়।  
- `grid-template-rows` এবং `grid-template-columns` দিয়ে সারি ও কলামের মাপ নির্ধারণ করা হয়।  
- `grid-area` দিয়ে উপাদানগুলো গ্রিডে স্থান পায়।  
...
|---------------------|--------------------------------|--------------------------------|  
| লেআউট প্রকার         | এক-মাত্রিক (1D: Row বা Column)| দুই-মাত্রিক (2D: Row ও Column)|  
| অ্যালাইনমেন্ট       | প্রধানত ফ্লেক্স আইটেম সাজানো | সম্পূর্ণ লেআউট ডিজাইন করা   |  
| সহজ উদাহরণ         | Navbar, Button Group          | Web Page Layout               |  
| জটিলতা সমাধান       | কম জটিল লেআউট                 | জটিল লেআউট তৈরি করতে কার্যকর |  

---

### **55. CSS Grid-এর জন্য Template Areas কীভাবে ব্যবহার করবেন?**  
Template Areas ব্যবহার করে গ্রিড লেআউটের নামকরণ করা যায় এবং কন্টেন্ট স্থাপন সহজ হয়।  
...
- **Justify-content:** ফ্লেক্স আইটেমগুলোকে প্রধান অক্ষ (main axis) বরাবর অ্যালাইন করে।  
  - উদাহরণ: `justify-content: center;` (সেন্টারে আইটেম)।  
- **Align-items:** ফ্লেক্স আইটেমগুলোকে ক্রস অক্ষ (cross axis) বরাবর অ্যালাইন করে।  
  - উদাহরণ: `align-items: stretch;` (উচ্চতা প্রসারিত)।  

---

### **57. Grid-এর Repeat ফাংশন কী? উদাহরণ দিন।**  
`repeat()` ফাংশন বারবার একই ধরণের গ্রিড ট্র্যাক তৈরি করে।  
```css
.container {
  display: grid;
...
```
**উদাহরণে:** তিনটি সমান কলাম তৈরি হয়।

---

### **58. Flexbox-এ Wrapping কী এবং এটি কীভাবে কাজ করে?**  
Flexbox-এ Wrapping নির্ধারণ করে যে ফ্লেক্স আইটেমগুলো এক লাইনেই থাকবে নাকি প্রয়োজন অনুযায়ী একাধিক লাইনে যাবে।  
...
- `flex-wrap: wrap;` (প্রয়োজনে নতুন লাইনে যাবে)।  

---

### **59. Auto-placement কীভাবে Grid Layout-এ কাজ করে?**  
Grid Layout-এ `auto-placement` উপাদানগুলোকে স্বয়ংক্রিয়ভাবে গ্রিডে স্থাপন করে।  
...
**ব্যাখ্যা:** গ্রিড কন্টেইনারে পর্যাপ্ত জায়গা না থাকলে নতুন সারি তৈরি করে উপাদান রাখে।  

---

### **60. Flex এবং Grid ব্যবহার করার শ্রেষ্ঠ উপায় কী?**  
- **Flexbox:** ছোট লেআউট বা এক-মাত্রিক ডিজাইনের জন্য যেমন Navbar, Button Group।  
- **Grid:** জটিল এবং দুই-মাত্রিক ডিজাইনের জন্য যেমন ওয়েবপেজের মূল লেআউট।  

**উপসংহার:** Flexbox এবং Grid একত্রে ব্যবহার করে উন্নত এবং রেসপন্সিভ ডিজাইন তৈরি করা যায়।  
